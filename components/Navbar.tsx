...
const Navbar = (props: Props) => {
  ...
  return (
    <nav className="flex items-center gap-6  h-[4rem] border-b backdrop-blur-md fixed w-full z-[100] bg-white/80 ">
      <BasicContainer className=" flex-row  items-center ">
        ...
        <div className="w-full flex items-center h-full gap-4 justify-end">
          ...
          >
            ...
            <text className="border px-1 rounded bg-white text-sm">CtrlK</text>
          </Button>
